...
angular.module('allure', ['pascalprecht.translate', 'angular-loading-bar', 'ngAnimate', 'ui.bootstrap', 'localStorageModule', 'ui.router',
    ...
    .config(function ($stateProvider, $urlRouterProvider, testcaseProvider) {
        ...
        $stateProvider
            .state('overview', {
                url: '/',
                templateUrl: "/allure/templates/overview.html",
            ...
            .state('defects', {
                url: '/defects',
                templateUrl: "/allure/templates/defects.html",
            ...
            .state('home', {
                url: "/home",
                templateUrl: "/allure/templates/home.html",
                controller: 'HomeCtrl',
                resolve: {
                    testsuites: function($http) {
                        return $http.get('data/xunit.json').then(processResponse);
            ...
            .state('graph', {
                url: '/graph',
                templateUrl: "/allure/templates/graph.html",
            ...
            .state('timeline', {
                url: '/timeline',
                templateUrl: "/allure/templates/timeline.html",
            ...
            .state('features', {
                url: '/features',
                templateUrl: "/allure/templates/features.html",
